...
class DepositsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deposit" do
    assert_difference("Deposit.count") do
      post deposits_url, params: { deposit: { amount: @deposit.amount, bank_account_id: @deposit.bank_account_id } }
    end
  ...
  test "should update deposit" do
    patch deposit_url(@deposit), params: { deposit: { amount: @deposit.amount, bank_account_id: @deposit.bank_account_id } }
