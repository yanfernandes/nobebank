...
class WithdrawsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create withdraw" do
    assert_difference("Withdraw.count") do
      post withdraws_url, params: { withdraw: { amount: @withdraw.amount, bank_account_id: @withdraw.bank_account_id } }
    end
  ...
  test "should update withdraw" do
    patch withdraw_url(@withdraw), params: { withdraw: { amount: @withdraw.amount, bank_account_id: @withdraw.bank_account_id } }
